...
- [Tart](https://tart.run): macOS and Linux VMs on Apple Silicon (licensed under [FSL-1.1-ALv2](https://tart.run/licensing/); free for individuals, commercial use may require a paid license)
